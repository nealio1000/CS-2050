...
public class BlockGame3 extends Basic
{
  public static void main(String[] args)
  {
    // example: hard-coded location and size of window:
    BlockGame3 a = new BlockGame3("Exciting Food Game", 0, 0, 600, 600);
  ...
  public BlockGame3( String title, int ulx, int uly, int pw, int ph )
  {
